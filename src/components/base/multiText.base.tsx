...
interface IBTextMultiProps
  extends Omit<React.ComponentProps<typeof BText>, 'children' | 'style'> {
  children: string;
 ...
 * @constructor
 */
export default function BTextMulti({
  children,
  ...props
}: IBTextMultiProps & TMultiStyles) {
